...
<template>
    <!--  Errors messages  -->
    <div v-if="Object.keys(form.errors).length !== 0" class="px-2 py-1 bg-[rgb(192,92,72)] border border-[rgba(0,0,0,0.1)] text-white rounded mb-6">
        <p v-for="error in form.errors">{{ error }}</p>
    </div>

    <Head :title="kata ? 'Edit kata: ' + kata.name : 'Create kata'"/>
        ...
        <div class="md:flex md:flex-row py-4">
            ...
            <div class="md:w-1/2 md:pr-4 text-sm">
                ...
                <div class="mt-8 mb-3">
                    ...
                    <ul class="flex flex-wrap">
                        <KataCategoryCheckbox
                            ...
                            icon="reference"
                            v-tippy="'Code that tests the ability to utilize core language features and APIs'"
                        >
                            Fundamentals
                        </KataCategoryCheckbox>
                        <KataCategoryCheckbox
                            ...
                            icon="algorithm"
                            v-tippy="'Code that needs to be created in order to meet the criteria specified. Typically these types of katas involve elaborate specifications.'"
                        >
                            Algorithms
                        </KataCategoryCheckbox>
                        <KataCategoryCheckbox
                            ...
                            icon="bug"
                            v-tippy="'Code that is broken and needs to be corrected in order for it to work as expected.'"
                        >
                            Bug Fixes
                        </KataCategoryCheckbox>
                        <KataCategoryCheckbox
                            ...
                            icon="cone"
                            v-tippy="'Code that needs to be transformed in some way, usually to create code that is either more DRY, efficient or readable.'"
                        >
                            Refactoring
                        </KataCategoryCheckbox>
                        <KataCategoryCheckbox
                            ...
                            icon="rubix"
                            v-tippy="'Code that is fun to play and involves solving puzzles that may not be strictly programming challenges'"
                        >
                            Puzzles
                        </KataCategoryCheckbox>
                    </ul>
                ...
                <div class="flex flex-col mb-5">
                    <label for="rank">
                        <i v-tippy="'Choose the rank you are expecting this kata to be ranked as.'" class="icon-moon-info mr-1"/>
                        Estimated Rank:
                    </label>
                ...
                <label class="inline-flex items-center mb-8" for="coauthors_wanted">
                    ...
                    <span v-tippy="`Check to allow users with the 'contributor' ability to make changes to
        ...
        <div class="text-sm my-4">
            ...
            <div class="md:flex md:flex-row mb-4 space-y-2 md:space-y-0">
                ...
                <div class="md:w-2/3 flex flex-col">
                    <label for="language">
                        Languages:
                        <i class="icon-moon-info mr-1" v-tippy="`Select the language you wish to create the kata with. You can select multiple languages by editing them one at a time. Any languages that have been saved will have an X next to them indicating that they can be removed.`"/>
                    </label>
                    <div class="flex space-x-4">
                        ...
                        >
                            <option v-for="lang in allLangs" value="lang.slug">{{ lang.name }}</option>
                ...
                <div class="md:w-1/2">
                    <Tabs ref="solutionsTabs">
                        <Tab title="Complete Solution" :selected="true"
                             v-tippy="'This is where you will code a complete working solution.'">
                            <textarea v-model="form.solution" id="complete_solution"></textarea>
                        </Tab>
                        <Tab title="Initial Solution"
                             v-tippy="'This is the initial code that a user will see when taking the kata'">
                            <textarea id="initial_solution">Initial Solution textarea!</textarea>
                        </Tab>
                        <Tab title="Preloaded"
                             v-tippy="'This is an optional set of code'">
                ...
                <div class="md:w-1/2">
                    <Tabs ref="testCasesTabs">
                        <Tab title="Test Cases" :selected="true"
                             v-tippy="'Provide test cases that will determine if the solution is valid or not'">
                            <textarea id="test_cases">Test Cases textarea!</textarea>
                        </Tab>
                        <Tab title="Example Test Cases"
                             v-tippy="'Use this code block to provide some example test cases that will be preloaded for the user.'"
                        >
